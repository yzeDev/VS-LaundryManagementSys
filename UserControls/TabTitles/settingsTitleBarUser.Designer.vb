...
Partial Class settingsTitleBarUser
    ...
    Private Sub InitializeComponent()
        ...
        Label2.TabIndex = 2
        Label2.Text = "Configure account settings such as profile data, password management, and pricing adjustments."
        Label2.TextAlign = ContentAlignment.MiddleLeft
        ' 
        ' settingsTitleBarUser
        ' 
        AutoScaleDimensions = New SizeF(7F, 15F)
        AutoScaleMode = AutoScaleMode.Font
        Controls.Add(TableLayoutPanel1)
        Name = "settingsTitleBarUser"
