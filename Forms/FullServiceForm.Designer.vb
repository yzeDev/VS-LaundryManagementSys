...
Partial Class FullServiceForm
    ...
    Private Sub InitializeComponent()
        ...
        Label4.TabIndex = 1
        Label4.Text = "Full Service Transaction"
        ...
        lblRate.TabIndex = 1
        lblRate.Text = "• Wash, Dry, and Fold" & vbCrLf & " • Rate: ₱100/kg" & vbCrLf
        ...
        Guna2txtboxName.Location = New Point(0, 36)
        Guna2txtboxName.Margin = New Padding(0)
        ...
        Guna2txtboxName.Size = New Size(490, 37)
        Guna2txtboxName.TabIndex = 1
        ' 
        ' TableLayoutPanel5
        ' 
        TableLayoutPanel5.ColumnCount = 2
        TableLayoutPanel5.ColumnStyles.Add(New ColumnStyle(SizeType.Percent, 56.1497345F))
        TableLayoutPanel5.ColumnStyles.Add(New ColumnStyle(SizeType.Percent, 43.8502655F))
        ...
        TableLayoutPanel5.Controls.Add(Guna2txtboxWeight, 1, 1)
        ...
        Label10.Font = New Font("Poppins", 12F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        Label10.Location = New Point(278, 0)
        Label10.Name = "Label10"
        Label10.Size = New Size(209, 36)
        Label10.TabIndex = 4
        ...
        Guna2txtboxContact.CustomizableEdges = CustomizableEdges18
        ...
        Guna2txtboxContact.DisabledState.ForeColor = Color.FromArgb(CByte(138), CByte(138), CByte(138))
        Guna2txtboxContact.DisabledState.PlaceholderForeColor = Color.FromArgb(CByte(138), CByte(138), CByte(138))
        Guna2txtboxContact.Dock = DockStyle.Left
        ...
        Guna2txtboxContact.ShadowDecoration.CustomizableEdges = CustomizableEdges19
        Guna2txtboxContact.Size = New Size(254, 29)
        ...
        Guna2txtboxWeight.CustomizableEdges = CustomizableEdges20
        Guna2txtboxWeight.DefaultText = ""
        Guna2txtboxWeight.DisabledState.BorderColor = Color.FromArgb(CByte(208), CByte(208), CByte(208))
        Guna2txtboxWeight.DisabledState.FillColor = Color.FromArgb(CByte(226), CByte(226), CByte(226))
        Guna2txtboxWeight.DisabledState.ForeColor = Color.FromArgb(CByte(138), CByte(138), CByte(138))
        Guna2txtboxWeight.DisabledState.PlaceholderForeColor = Color.FromArgb(CByte(138), CByte(138), CByte(138))
        Guna2txtboxWeight.Dock = DockStyle.Right
        Guna2txtboxWeight.FocusedState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        Guna2txtboxWeight.Font = New Font("Poppins", 12F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        Guna2txtboxWeight.HoverState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        Guna2txtboxWeight.Location = New Point(284, 40)
        Guna2txtboxWeight.Margin = New Padding(9, 4, 9, 4)
        Guna2txtboxWeight.Name = "Guna2txtboxWeight"
        Guna2txtboxWeight.Padding = New Padding(3, 3, 3, 3)
        Guna2txtboxWeight.PlaceholderText = ""
        Guna2txtboxWeight.SelectedText = ""
        Guna2txtboxWeight.ShadowDecoration.CustomizableEdges = CustomizableEdges21
        Guna2txtboxWeight.Size = New Size(197, 29)
        Guna2txtboxWeight.TabIndex = 6
        ' 
        ' TableLayoutPanel6
        ' 
        ...
        TableLayoutPanel7.Font = New Font("Poppins", 9F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        ...
        TableLayoutPanel8.ColumnStyles.Add(New ColumnStyle(SizeType.Percent, 4.36363649F))
        TableLayoutPanel8.ColumnStyles.Add(New ColumnStyle(SizeType.Percent, 95.63636F))
        ...
        Guna2CheckBoxPickup.Location = New Point(13, 3)
        Guna2CheckBoxPickup.Name = "Guna2CheckBoxPickup"
        Guna2CheckBoxPickup.Size = New Size(112, 22)
        Guna2CheckBoxPickup.TabIndex = 8
        ...
        TableLayoutPanel9.ColumnStyles.Add(New ColumnStyle(SizeType.Percent, 91.3043442F))
        TableLayoutPanel9.ColumnStyles.Add(New ColumnStyle(SizeType.Percent, 8.695652F))
        TableLayoutPanel9.ColumnStyles.Add(New ColumnStyle(SizeType.Absolute, 234F))
        ...
        TableLayoutPanel9.RowStyles.Add(New RowStyle(SizeType.Absolute, 24F))
        TableLayoutPanel9.Size = New Size(490, 40)
        TableLayoutPanel9.TabIndex = 8
        ' 
        ' gbCancel
        ' 
        gbCancel.Dock = DockStyle.Right
        gbCancel.Font = New Font("Poppins", 9F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        gbCancel.Location = New Point(125, 2)
        gbCancel.Margin = New Padding(3, 2, 3, 2)
        gbCancel.Name = "gbCancel"
        gbCancel.Size = New Size(105, 36)
        gbCancel.TabIndex = 35
        ...
        gbContinue.Location = New Point(258, 2)
        gbContinue.Margin = New Padding(3, 2, 3, 2)
        gbContinue.Name = "gbContinue"
        gbContinue.ShadowDecoration.CustomizableEdges = CustomizableEdges13
        gbContinue.Size = New Size(105, 33)
        gbContinue.TabIndex = 37
        ...
        lblTransactionID.Size = New Size(154, 33)
