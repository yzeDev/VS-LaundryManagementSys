...
Partial Class DryCleaningForm
    ...
    Private Sub InitializeComponent()
        ...
        Guna2txtboxQuantity = New Guna.UI2.WinForms.Guna2TextBox()
        Label10 = New Label()
        Label9 = New Label()
        Guna2txtboxContact = New Guna.UI2.WinForms.Guna2TextBox()
        Label8 = New Label()
        gcbClotheSize = New Guna.UI2.WinForms.Guna2ComboBox()
        ...
        Label4.TabIndex = 1
        Label4.Text = "Dry Cleaning Transaction"
        ...
        Label5.TabIndex = 0
        Label5.Text = "Rate based on clothing size:"
        ...
        lblRate.TabIndex = 1
        lblRate.Text = "• Small: ₱80 per piece" & vbCrLf & "• Medium: ₱100 per piece" & vbCrLf & "•  Large: ₱120 per piece"
        ...
        TableLayoutPanel5.ColumnStyles.Add(New ColumnStyle(SizeType.Percent, 25.0F))
        TableLayoutPanel5.Controls.Add(Guna2txtboxQuantity, 2, 1)
        ...
        TableLayoutPanel5.Controls.Add(gcbClotheSize, 1, 1)
        ...
        Guna2txtboxQuantity.DisabledState.ForeColor = Color.FromArgb(CByte(138), CByte(138), CByte(138))
        Guna2txtboxQuantity.DisabledState.PlaceholderForeColor = Color.FromArgb(CByte(138), CByte(138), CByte(138))
        Guna2txtboxQuantity.Dock = DockStyle.Fill
        Guna2txtboxQuantity.FocusedState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        Guna2txtboxQuantity.Font = New Font("Microsoft Sans Serif", 12.0F)
        Guna2txtboxQuantity.HoverState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        Guna2txtboxQuantity.Location = New Point(371, 45)
        Guna2txtboxQuantity.Margin = New Padding(4, 9, 4, 9)
        ...
        Guna2txtboxContact.Font = New Font("Microsoft Sans Serif", 12.0F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        ...
        gcbClotheSize.FocusedState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        gcbClotheSize.Font = New Font("Microsoft Sans Serif", 12.0F)
        gcbClotheSize.ForeColor = Color.FromArgb(CByte(68), CByte(88), CByte(112))
        gcbClotheSize.ItemHeight = 25
        ...
        gbContinue.Font = New Font("Microsoft Sans Serif", 12.0F)
    ...
    Friend WithEvents Guna2txtboxQuantity As Guna.UI2.WinForms.Guna2TextBox
    Friend WithEvents gcbClotheSize As Guna.UI2.WinForms.Guna2ComboBox
